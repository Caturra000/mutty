...
// dlog version: ca2e76fc1604880b77809ffd6725f17661c607fd
...
#endif
#ifndef __DLOG_DIGITS_H__
#define __DLOG_DIGITS_H__
#include <bits/stdc++.h>
namespace dlog {

// printf("const char little[][3] = {\n");
// for(int i = 0; i < 100; ++i) {
//     printf("    \"%02d\",%c", i, ((i+1)%10==0)? '\n' : ' ');
// }
// printf("};\n");

// MM dd hh mm ss
const char digits100[][3] = {
...
#define DLOG_DEBUG_ALIGN(...) Log::debug(filename(__FILE__), __LINE__, \
    dlog::Whitespace<(size_t)std::max(ssize_t(1), ssize_t(dlog::staticConfig.msg_align) \
